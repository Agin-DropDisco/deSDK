...
describe('Pair', () => {
  ...
  describe('#getAddress', () => {
    it('returns the correct address', () => {
      const usdc = new Token(ChainId.MAINNET, '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', 18, 'USDC', 'USD Coin')
      const dai = new Token(ChainId.MAINNET, '0x6B175474E89094C44Da98b954EedeAC495271d0F', 18, 'DAI', 'DAI Stablecoin')
      expect(Pair.getAddress(usdc, dai, RoutablePlatform.DEXSWAP)).toEqual('0x0e18852eE5CE266E2Ce6f4844Ba04cd9CD11AF5B')
    })
  })
  ...
  describe('#getAddressFromUniswap', () => {
    it('returns the correct address from Uniswap rather than DexSwap', () => {
      const usdc = new Token(ChainId.MAINNET, '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', 18, 'USDC', 'USD Coin')
  ...
  describe('#fetchData', () => {
    it.skip('returns the correct address', async () => {
      const pairAddress = Pair.getAddress(Token.WETH[ChainId.RINKEBY], TEST_TOKENS.WEENUS[ChainId.RINKEBY], RoutablePlatform.DEXSWAP)
      ...
      expect(pairData.liquidityToken.name).toEqual('DEXswap')
    })
  })
